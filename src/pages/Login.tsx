// PostPilot — Page Login / Inscription
// Sprint 0 : connexion email + Google. Inscription → onboarding.
...
export default function Login() {
  ...
  const handleGoogle = async () => {
    ...
    // Supabase redirige automatiquement → pas de navigate ici
  }

  const titles: Record<Mode, { title: string; description: string; cta: string }> = {
    login: {
      title: 'Connexion',
      description: 'Accédez à votre espace PostPilot',
      cta: 'Se connecter',
    },
    signup: {
      title: 'Créer un compte',
      description: 'Commencez à publier sur LinkedIn en 5 minutes',
  ...
  const { title, description, cta } = titles[mode]
